...
var bt = new Le();
var St = new Le();
var Tr = /* @__PURE__ */ new Uint8Array(30);
var kr = /* @__PURE__ */ new Uint16Array(30);
var Tt = /* @__PURE__ */ new Uint8Array(30);
var kt = /* @__PURE__ */ new Uint16Array(30);
var ga = new Uint8Array([
	16,
	17,
	18,
	0,
...
var Br = new Le();
var se = /* @__PURE__ */ new Uint8Array(320);
function Ft(e, r, t, a) {
	var n, s;
	for (n = 0; n < t; ++n) e[n] = 0;
...
var Ir = /* @__PURE__ */ new Uint16Array(16);
function ar(e, r, t, a) {
	var n, s;
	...
	for (var n = this.getFeatureLookups(a), s = [].concat(r.context), i = 0; i < n.length; i++) for (var u = n[i], o = this.getLookupSubtables(u), l = 0; l < o.length; l++) {
		...
		switch (h) {
			...
			case "41":
				...
				break;
			case "21": c = p(r.current), c && s.splice(t, 1, new be({
				id: 21,
				tag: e.tag,
				substitution: c
			}));
